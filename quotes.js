...
[
    ...
    [
        "*Luna, 10年後の私になら / Only to me in 10 years (Kohana Lam's translation)",
        "You are still sneaky, aren't you?\nYou can't wait to escape"
    ],
    [
        "*Luna, 10年後の私になら / Only to me in 10 years (Kohana Lam's translation)",
        "You may not be able to run with these legs, but you are the one who chose trying to walk somehow"
    ],
    [
        "*Luna, 8.32",
    ...
    [
        "*Luna, Adventure Log",
        "Cela ne me dérange pas s'il se salit, car il est plus beau lorsqu'il est usé"
    ],
    [
        "*Luna, Adventure Log",
    ...
    [
        "*Luna, Check This Out",
        "No matter what anyone said, I want you to notice it\nCheck this out!"
    ],
    [
        "*Luna, Check This Out",
        "Tu m'es appris que c'était bien d'être fou"
    ],
    [
        "*Luna, Check This Out",
    ...
    [
        "*Luna, 僕らの夏はまた巡って (Our Summer Will Come Again)",
        "What's wrong with crying out loud\nWhenever you fall, get scraped, or covered in mud?"
    ],
    [
        "*Luna, 夏が僕らを呼ぶのなら (If Summer is calling us) ",
        "If there aren't enough promises, let's make them again and again"
    ],
    [
        "*Luna, 夏が僕らを呼ぶのなら (If Summer is calling us) ",
    ...
    [
        10,
        "May the pain from the past never damage you"
    ],
    [
        10,
    ...
    [
        "Girls last tour, Endless Journey",
        "This endless road is not a mistake. It's to the future."
    ],
    [
    ...
    [
        ...
        "Whatever future lies ahead, you will be all right.\nYou'll illuminate it with the light you're yet to know."
    ],
    [
        "KZ-Livetune, ジュビリ",
        "We searched so long for perfect sound, in midst of crying, we're always laughing, and that's what's pushing us along."
    ],
    [
        "KZlivetune, Far Away (bambooXZX's translation)",
        "Maybe I'll come to love the unknown tomorrow"
    ],
    [
        "Les Cowboys Fringants, Les étoiles filantes",
        "Cause you know, to look too far ahead is no better than looking back"
    ],
    [
        "Les Cowboys Fringants, Les étoiles filantes",
        "Parce que tsé, voir trop loin\nC'past mieux que de r'garder en arrière"
    ],
    [
        "MgTyle",
    ...
    [
        "Orangestar, Daydream Skytrain (Translyrics by rachie)",
        "Hey, don't just wait — make it happen instead"
    ],
    [
        "Orangestar, Daydream Skytrain (Translyrics by rachie)",
        "If we're gonna waste the summer, might as well we make them remember just what we can be"
    ],
    [
        "PIKASONIC, ColorCode-F",
        "If your dream is stained with someone else's color\nLet's go back to the beginning color."
    ],
    [
    ...
    [
        "Qeiru, フィクション (Fiction)",
        "Let's rest a little longer, until the sadness melts away"
    ],
    [
        "Qeiru, 世界線第二ターミナル (World Line Terminal 2)",
        "Hating the hopeless present, I throw it away, saying I don't know anymore"
    ],
    [
        "Stardust Telepath",
        "I don't think making other lose is the only condition of winning"
    ],
    [
        "Stephen Hawking",
        "Alors n'oubliez pas de regarder les étoiles et non vos pieds"
    ],
    [
        "Stephen Hawking",
